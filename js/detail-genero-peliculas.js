document.addEventListener('DOMContentLoaded', function () {
    ...
    let urlDetalleGenero = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&with_genres=${id_genero}`;

    let contenedor = document.querySelector('.genero-peliculas')
        ...
        .then(function (data) {
            ...
            for (let i = 0; i < 9; i++) {
                ...
                contenido += `<article class="pelicula-inicio">
                            ...
                            <p>${el.title}</p>
                            <p>Fecha de estreno: ${el.release_date}</p>
                        </article>`
